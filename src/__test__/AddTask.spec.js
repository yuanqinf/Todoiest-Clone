...
describe("<AddTask />", () => {
  ...
  describe("Success", () => {
    ...
    it("renders the <AddTask /> main showable when using click", () => {
    ...
    it("renders the <AddTask /> for quick add task and using onClick", () => {
    ...
    it("renders <AddTask /> and adds a task to the Upcoming and clears state", () => {
      useSelectedProjectValue.mockImplementation(() => ({
